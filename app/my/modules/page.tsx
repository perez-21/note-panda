...
export default async function Page(props: {
  ...
  function filterModules(
    ...
    filteredModules = filteredModules.filter((module) => {
      ...
      const titleMatch = regex.test(module.title);
      const descriptionMatch = regex.test(module.description);
          ...
          <div className="border-b border-gray-200 dark:border-gray-700/50 mb-6">
            <nav aria-label="Tabs" className="-mb-px flex space-x-8">
              ...
              <Link
                ...
                href="/my/modules?status=Published"
              >
                Published
              </Link>
              <Link
                ...
                href="/my/modules?status=Archived"
              >
                Archived
              </Link>
            </nav>
            ...
            <section>
              {modules.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {filterModules(currentPage, query, status).map((module) => {
                    return (
                ...
                <div className="text-center py-12 px-6 bg-white dark:bg-background-dark/50 rounded-lg border border-gray-300 dark:border-gray-700">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 max-w-xs mx-auto mt-1 mb-4">
                    Be the first to create a module
                  </p>
